...
public class Marco extends javax.swing.JFrame {
    ...
    public Marco() {
        ...
        OyenteEnter o = new OyenteEnter();
        
        jTextField1.addKeyListener(o);
        jTextField2.addKeyListener(o);
        jTextField3.addKeyListener(o);
        jTextField4.addKeyListener(o);
    ...
    private class OyenteEnter extends KeyAdapter {
        ...
        public void keyPressed(KeyEvent e) {
            ...
            if(e.getKeyCode() == KeyEvent.VK_ENTER) {
                ...
                } else if(e.getSource().equals(jTextField2)) {
                    
                    jTextField3.requestFocus();
                    jTextField3.selectAll();
                    
                } else if(e.getSource().equals(jTextField3)) {
